...
<template>
  ...
  <button class="mr-1 group hover:pointer focus:scale-110" :class="{ 'is-liked': props.isLiked, 'is-disabled': props.isDisabled }" type="button" aria-label="like request" @click="emitLikeButtonClicked" :disabled="props.isDisabled">
